...
public class Graph_M
{
    ...
    public int dijkstra(String src, String des, boolean nan)
    {
        ...
        JOURNEY_PLANNER.Heap<DijkstraPair> heap = new JOURNEY_PLANNER.Heap<>();
...
g.addVertex("Nehru Park~G");
g.addVertex("Egmore~G");
g.addVertex("May Day Park~G");

g.addEdge("Washermenpet~B", "Mannadi~B", 1);
g.addEdge("Mannadi~B", "High Court~B", 1);
g.addEdge("High Court~B", "Chennai Central~B", 2);
g.addEdge("Chennai Central~B", "Government Estate~B", 1);
g.addEdge("Government Estate~B", "LIC~B", 1);
g.addEdge("LIC~B", "Thousand Lights~B", 1);
g.addEdge("Thousand Lights~B", "AG-DMS~B", 2);
g.addEdge("AG-DMS~B", "Teynampet~B", 1);
g.addEdge("Teynampet~B", "Nandanam~B", 1);
g.addEdge("Nandanam~B", "Saidapet~B", 2);
g.addEdge("Saidapet~B", "Little Mount~B", 2);
g.addEdge("Little Mount~B", "Guindy~B", 2);
g.addEdge("Guindy~B", "Alandur~BG", 1);
g.addEdge("Alandur~BG", "Nanganallur Road~B", 2);
g.addEdge("Nanganallur Road~B", "Meenambakkam~B", 2);
g.addEdge("Meenambakkam~B", "Chennai International Airport~B", 2);
g.addEdge("Alandur~BG", "St. Thomas Mount~BG", 2);
g.addEdge("Ekkattuthangal~B", "Ashok Nagar~B", 2);
g.addEdge("Ashok Nagar~B", "Vadapalani~B", 2);
g.addEdge("Vadapalani~B", "Arumbakkam~B", 1);
g.addEdge("Arumbakkam~B", "CMBT~B", 1);
g.addEdge("CMBT~B", "Koyambedu~B", 1);
g.addEdge("Koyambedu~B", "Thirumangalam~G", 3);
g.addEdge("Thirumangalam~G", "Anna Nagar Tower~G", 1);
g.addEdge("Anna Nagar Tower~G", "Anna Nagar East~G", 1);
g.addEdge("Anna Nagar East~G", "Shenoy Nagar~G", 1);
g.addEdge("Shenoy Nagar~G", "Kilpauk~G", 1);
g.addEdge("Kilpauk~G", "Nehru Park~G", 2);
g.addEdge("Nehru Park~G", "Egmore~G", 2);
g.addEdge("Egmore~G", "May Day Park~G", 1);
